  ...
  return (
    <div className="min-h-screen bg-[#0a0612] flex items-center justify-center p-6 text-white text-center">
      <div className="max-w-md w-full p-10 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl">
        ...
        <h2 className="text-2xl font-black mb-2">Failed to Load Plans</h2>
        <p className="text-gray-400 mb-8">We couldn't retrieve the latest pricing information. This might be a temporary network issue.</p>
        <button 
          onClick={reset} 
