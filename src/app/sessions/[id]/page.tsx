...
import { Users, Info, Shield, Video, Mic, ClipboardCheck } from 'lucide-react';
import { LoadingPage } from '@/components/ui/Loading';

export default function LiveSessionRoomPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
  const { user } = useAuth();
