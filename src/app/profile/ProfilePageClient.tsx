          ...
          <div className="flex flex-col gap-8">
            <div className={styles.sectionCard}>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between p-4 rounded-xl bg-gray-50 border border-gray-100 dark:bg-white/5 dark:border-white/10 text-gray-700 dark:text-gray-300">
                  <div className="text-sm font-semibold">Email Verification</div>
                  <CheckCircle2 className="w-5 h-5 text-green-500" />
                </div>
                <div className="flex items-center justify-between p-4 rounded-xl bg-gray-50 border border-gray-100 dark:bg-white/5 dark:border-white/10 text-gray-700 dark:text-gray-300">
                  <div className="text-sm font-semibold">2FA Security</div>
                  <button className="text-xs text-blue-600 dark:text-indigo-400 font-bold hover:underline">Enable</button>
                </div>
              </div>
            </div>

            <div className="p-8 rounded-3xl bg-gradient-to-br from-indigo-600 to-purple-700 text-white shadow-xl">
              <Zap className="w-10 h-10 mb-4 text-yellow-300 fill-yellow-300" />
              <h3 className="text-xl font-extrabold mb-2">Upgrade to Plus</h3>
              <p className="text-indigo-100 text-sm mb-6 leading-relaxed">Get early access to mentor sessions, priority doubt resolution, and exclusive industry resources.</p>
              <button className="w-full py-3 bg-white text-indigo-700 font-bold rounded-xl hover:bg-indigo-50 transition-colors">Start Free Trial</button>
            </div>
          </div>
        </div>
      </div>
