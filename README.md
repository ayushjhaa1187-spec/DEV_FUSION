...
| **Cards** | `rounded-2xl + shadow-xl` | Doubt cards, mentor cards, test result panels |
...
| **AI Layer** | LLM API for doubt solving + MCQ generation |
| **Realtime / Notifications** | WebSockets / Firebase / Supabase Realtime |
| **Meetings** | Google Meet / Jitsi |
| **Payments** | Razorpay Sandbox / Stripe Sandbox |
...
| Entry Point | Landing Path | Goal for Judge |
| :--- | :--- | :--- |
| **The Student** | Login → Doubt Feed → Ask AI First | Experience instant doubt solving and community fallback |
| **The Contributor** | Doubt Feed → Open Question → Answer | Experience voting, accepted answers, and reputation loop |
| **The Mentor** | Mentor Dashboard → Slot Setup → Session Booking | Experience mentoring workflow and monetization |
| **The Learner** | Practice Tests → Topic Select → Timed Quiz | Experience AI-generated assessment and progress tracking |
| **The Admin** | Admin Panel → Mentor Applications | Experience platform governance and trust layer |

---

## ⚖️ Evaluation Criteria Alignment

| Criterion | SkillBridge Implementation |
| :--- | :--- |
| **Problem Relevance** | Directly solves doubt resolution, peer learning, and accessible mentoring for students |
| **Innovation** | Combines AI-first answering with community validation and live mentor booking |
| **User Experience** | Structured doubt feed, academic filters, public profiles, and guided flows |
| **Scalability** | Modular architecture across doubts, tests, mentors, gamification, and notifications |
| **Engagement** | Points, badges, accepted answers, and score history encourage repeat usage |
...
*Built for smarter student collaboration, faster doubt solving, and mentor-powered growth.*
